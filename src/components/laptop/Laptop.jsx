...
import './laptop.css';
import { FaWindows, FaWifi, FaAngleUp,FaAngleDown, FaBars } from 'react-icons/fa'
                ...
                <div className='laptop_taskbar-notif'>
                    ...
                    <div className='laptop_taskbar-notif-content'>
                        <div className='dateTime'>
                            <p>{time.getHours() > 11 ? (time.getHours() - 12) : time.getHours()}{":"}{('0' + (time.getMinutes())).slice(-2)}{timer}</p>  
                            <p>{currentDate}</p>               
                        </div>
                    </div>
                </div>
